...
(function($, window, document, undefined) {
	...
	jRange.prototype = {
		...
		setPosition: function(pointer, position, isPx, animate) {
			...
			var singleNodeWidth = this.domNode.width()/(this.options.to/10);
			var barWidth;
			...
			position = (parseInt((position/singleNodeWidth).toFixed()) * singleNodeWidth);
			...
			barWidth = (parseInt((Math.round(highPos + circleWidth - leftPos)/singleNodeWidth).toFixed()) * singleNodeWidth);
		...
		showPointerValue: function(pointer, position, animate) {
			...
			// $("#modalBox-dealerScore").text(value);
			// $("#modalBox-dealerScore_value").val(value);
		...
		setInputValue: function(pointer, v) {
			...
			if (this.inputNode.val() !== this.options.value) {
				...
				this.options.onstatechange.call(this, this.options.value, this.inputNode);
			}
		},
		getValue: function() {
